...
def train_acc(run_id: str, syn_dir: str, models_dir: str, save_every: int, threads: int,
    ...
    for i, session in enumerate(hparams.tts_schedule):
        ...
        current_step = model.step.cpu().numpy().item(0)
        ...
        if current_step >= max_step:
            ...
            if i == len(hparams.tts_schedule) - 1:
                ...
                save(model, weights_fpath, optimizer)
                break
            else:
        ...
        while current_step < max_step:
            for step, (texts, mels, embeds, idx) in enumerate(data_loader, current_step):
                ...
                if backup_every != 0 and step % backup_every == 0:
                    ...
                    save(model, backup_fpath, optimizer)
...
def save(model, path, optimizer=None):
...
def loss(outputs):
    m1_hat, m2_hat, attention, stop_pred = outputs
